...
static char *fonts[]          = { "FantasqueSansMono Nerd Font Mono:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
static const Rule rules[] = {
	...
	*/
	...
	{ NULL,      "alacritty", NULL,       	    SPTAG(1),     1,           1,         0,        -1 },
};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_d,		spawn,          SHCMD("dmenu_run -nb '#1e1e1e' -sf '#1e1e1e' -sb '#d3869b' -nf '#d3869b' -fn 'Fira Code Nerd Font'") },
